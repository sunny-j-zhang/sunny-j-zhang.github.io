      ...
      <section style={{
        ...
        <div className="section" style={{ paddingTop: '8rem' }}>
          ...
          <h1 className="fade-up-2" style={{
            ...
            <em style={{ color: 'var(--canopy)', fontStyle: 'italic' }}>intersection</em><br />
            of craft and code.
          </h1>
          <p className="fade-up-3" style={{
            ...
            Building robotic systems, real-time software, and the tools to
            understand them — from cycloidal gearboxes to custom RTOS kernels.
          </p>
      ...
      <section style={{ background: 'var(--forest-mid)', borderTop: '1px solid rgba(74,124,89,0.2)', borderBottom: '1px solid rgba(74,124,89,0.2)' }}>
        <div className="section" style={{ paddingTop: '3.5rem', paddingBottom: '3.5rem' }}>
          ...
          <p style={{ fontSize: '1.15rem', maxWidth: '600px', color: 'var(--parchment-dim)', lineHeight: 1.8 }}>
            Mechanical engineer with a focus on robotics and embedded systems.
            Currently building a custom 6-DOF tabletop manipulator — from the
            cycloidal gearboxes up through the real-time OS. I care about the
            full stack: tolerances, kernel scheduling, and everything in between.
          </p>
        </div>
      </section>
        ...
        <div className="section">
          ...
          <div className="card" style={{ maxWidth: '600px' }}>
            ...
            <p style={{ color: 'var(--parchment-dim)', fontSize: '0.95rem', marginBottom: '1.5rem', lineHeight: 1.7 }}>
              ...
              STM32 servo layer. Documented in full from kinematics to kernel.
            </p>
