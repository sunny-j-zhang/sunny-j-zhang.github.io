...
const phases = [
  { title: 'Kinematics + DH parameters', window: 'May 2025', status: 'active', note: 'Workspace definition, torque budget, motor selection' },
  { title: 'Cycloidal gearbox CAD', window: 'Jun 2025', status: 'upcoming', note: 'Parametric epitrochoid in SolidWorks' },
  { title: 'Full platform CAD', window: 'Jul 2025', status: 'upcoming', note: '2-arm assembly, wire routing, gripper mount' },
  { title: 'Yocto + software architecture', window: 'Aug 2025', status: 'upcoming', note: 'RPi image booting, C++ daemon design' },
  { title: 'OS course + PREEMPT_RT + STM32', window: 'Sep–Oct 2025', status: 'upcoming', note: 'Kernel tuning, single-axis closed-loop control' },
  { title: '3-joint integration demo', window: 'Nov 2025', status: 'upcoming', note: 'RPi → STM32 SPI, demo video' },
  { title: 'Full 6-DOF control', window: 'Dec 2025–Feb 2026', status: 'upcoming', note: 'Trajectory planning, basic IK' },
  { title: 'WebSocket + portfolio integration', window: 'Mar–Apr 2026', status: 'upcoming', note: 'Live telemetry on this site' },
  { title: 'Tuning + documentation', window: 'May–Aug 2026', status: 'upcoming', note: 'System ID, final writeups' },
]
  ...
  return (
    <div>
      <div className="section" style={{ paddingTop: '8rem' }}>
        ...
        <p className="section-label fade-up">2025 – 2026 · ongoing</p>
